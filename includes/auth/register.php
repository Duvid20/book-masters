...
<div class="auth-page-container">
    ...
    <form class="auth-form" id="register-form" action="/" method="POST">
        <div class="user-input-area user-input-area-register active" id="register-username">
            <input class="text-input auth-item" id="register-username-input" type="text" name="username" placeholder="Username">
            <button class="auth-item auth-btn register-button">Continue</button>
        </div>
        ...
        <div class="user-input-area user-input-area-register" id="register-password">
            ...
            <input class="auth-item auth-btn" type="submit" value="Continue">
        </div>
